...
trait GuzzleMockSetupTrait
{
    ...
    private function getMockedApiReturnListing(): stdClass
    {
        $rawReturnString = <<<EOF
        {
            "data": [
    ...
    private function mockApiReturnSinglePokemon(): stdClass
    {
    ...
    private function mockApiReturnNonExistent(): stdClass
    {
        $apiMessage =<<<EOF
        {
            "error": {
